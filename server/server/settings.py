...
REST_FRAMEWORK = {
    ...
    # Issue 1: Global authentication — all endpoints require a valid token
    ...
    # Issue 16: API rate limiting — prevent abuse / DoS
...
# Issue 17: Enforce HTTPS and secure cookies when not in DEBUG mode.
